    ...
    <view class="signResult">
      <view class="signTable">
        ...
        <view class="signTr">
          ...
          <view class="signTd${index * 4 + 1}"><text class="signTd${index * 4 + 1}">${index + 1}</text></view>
          <view class="signTr${index * 4 + 1}b"></view>
          <view class="signTd${index * 4 + 2}"><text class="signTd${index * 4 + 2}">${item.checkProject}</text></view>
          <view class="signTr${index * 4 + 2}b"></view>
          <view class="signTd${index * 4 + 3}"><text class="signTd${index * 4 + 3}">${
              item.checkResult === 'success' ? '合格' : '不合格'
            }</text></view>
          ...
          <view class="signTr${index * 4 + 4}b"></view>
          <view class="signTd${index * 4 + 5}"><text class="signTd${index * 4 + 5}">${
            item.reasonAnalysis
          }</text></view>
        <view class="signTr${index * 4 + 5}b"></view>
        <view class="signTd${index * 4 + 6}"><text class="signTd${index * 4 + 6}">${
          item.measures
        }</text></view>
      <view class="signTr${index * 4 + 6}b"></view>
        </view>
        <view class="signTrb1"></view>
          `;
          })
